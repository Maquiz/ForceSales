...
abstract public class IssueTrackerSharedAdapter<A extends TaskShowViewHolderBase> extends RecyclerView.Adapter<A> {
    private IssueTrackerList mTaskList;

    public IssueTrackerSharedAdapter(IssueTrackerList taskList) {
        mTaskList = taskList;
    }
